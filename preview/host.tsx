...
const paths: Record<string, string[]> = {
  ...
  PanelsTopLeft: ['M3 3h18v18H3Z', 'M3 8h18', 'M8 8v13'], PanelLeft: ['M3 3h18v18H3Z', 'M9 3v18'], PanelRight: ['M3 3h18v18H3Z', 'M15 3v18'],
  ...
  Image: ['M3 4h18v16H3Z', 'm3 17 5-5 4 4 3-3 3 4', 'M16 9h.01'],
};
