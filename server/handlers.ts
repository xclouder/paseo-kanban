...
import type { AddInboxInput, CompleteReviewInput, CreateInput, CreateProjectWorkspaceInput, MoveInput, PatchInboxInput, PatchInput } from '../shared/contracts';
...
export const createProjectWorkspace = (input: CreateProjectWorkspaceInput, { paseo }: PluginHandlerContext) => service.createProjectWorkspace(input, paseo);
